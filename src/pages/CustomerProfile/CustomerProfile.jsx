    ...
    return (
        <>
            {userData && <div className='parent my-5 '>
                <div className={`m-5 container m-auto p-4 ${styles.mainColor}`} id="container">
                    <di className="row">
                    ...
                    <div className={`col-md-4 shadow rounded p-4 `} id="profileSection">
                        <div className="row m-auto text-center">
                            ...
                            <Link className='edit-profile mt-4' to='/editCustomerProfile' state={userData}> {t("Edit public profile")}</Link>
